...
@section('title', 'Edit Page – Cisadane Raya Chemicals CMS')
    ...
    <main class="admin-main">
        <div class="container">
                        ...
                        <div style="border: 1px solid #e5e7eb; border-radius: 0.5rem; padding: 1.5rem; background: #f9fafb;">
                            ...
                            <div class="field" style="margin-bottom: 1rem;">
                                ...
                                <input
                                    ...
                                    name="banner[title]"
                                    type="text"
                                    value="{{ old('banner.title', $page->banner['title'] ?? '') }}"
                            ...
                            <div class="field" style="margin-bottom: 1rem;">
                                ...
                                <input
                                    ...
                                    type="text"
                                    value="{{ old('banner.subtitle', $page->banner['subtitle'] ?? '') }}"
                            ...
                            <div class="field" style="margin-bottom: 1rem;">
                                ...
                                @enderror
                                <small style="color: #6b7280; font-size: 0.875rem; margin-top: 0.25rem; display: block;">
                                    Upload a new banner image (will replace existing image if set)
                                </small>
                            </div>
                            
                            <div id="banner_preview" style="margin-bottom: 1rem; {{ $page->banner && isset($page->banner['image']) ? '' : 'display: none;' }}">
                                <label style="font-size: 0.875rem; font-weight: 600; display: block; margin-bottom: 0.5rem;">Current Banner Preview</label>
                                <div style="border: 2px dashed #d1d5db; border-radius: 0.5rem; padding: 1rem; background: white; text-align: center;">
                                    <img 
                                        ...
                                        src="{{ $page->banner && isset($page->banner['image']) ? asset($page->banner['image']) : '' }}" 
                                        alt="Banner Preview" 
                                        style="max-width: 100%; max-height: 300px; border-radius: 0.5rem; display: {{ $page->banner && isset($page->banner['image']) ? 'block' : 'none' }}; margin: 0 auto;"
                                    />
                                    <div id="banner_preview_placeholder" style="display: {{ $page->banner && isset($page->banner['image']) ? 'none' : 'block' }}; color: #9ca3af; padding: 2rem;">
            ...
            <div class="admin-card" style="margin-top: 2rem;">
                <h2 style="font-size: 1.25rem; font-weight: 600; margin-bottom: 1rem;">Page Sections</h2>
                <p style="color: #6b7280; margin-bottom: 1rem;">
                    Manage content sections for this page. Sections allow you to add multiple content blocks.
                </p>
